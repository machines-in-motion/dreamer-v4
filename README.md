...
## Acknowledgement 
We would like to acklowledge the computational reserouces allocated to our project by NYU Torch and Jean Zay HPCs. This project is developed at NYU Machines in Motion Lab at NYU Center for Robotics and Embodied Intelligence with equal contribution from Joseph Amigo and Rooholla Khorrambakht. We would also like to acklowledge the use of AI (Preplexity, ChatGPT 5.2, and Gemeni) in accelerating the development of this project.
